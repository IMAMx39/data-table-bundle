...
class FilterTypeTest extends FilterTypeTestCase
{
    ...
    public function testDefaultOperatorDefaultValue(): void
    {
        ...
        $this->assertEquals(Operator::Equals->value, $filterView->vars['clear_filter_parameters']['operator']);
    }
    ...
    public function testPassingDefaultOperatorAsOption(): void
    {
        ...
        $this->assertEquals(Operator::NotEquals->value, $filterView->vars['clear_filter_parameters']['operator']);
    }
    ...
    public function testPassingEmptyDataAsOption(): void
    {
        $filter = $this->createFilter(['empty_data' => 'foo']);
        $filterView = $this->createFilterView($filter);

        $this->assertEquals('foo', $filter->getConfig()->getOption('empty_data'));
        $this->assertEquals('foo', $filterView->vars['clear_filter_parameters']['value']);
    }
    ...
    public function testApplyingFilter(): void
    {
        $query = $this->createMock(ProxyQueryInterface::class);
        $query->expects($this->never())->method($this->anything());
